...
*Acceptance Criteria*: Defined user story (https://cucumber.io/docs/terms/user-story#acceptance-criteria-using-cucumber-language). Definition of reaching the end (based on https://cucumber.io/docs/terms/user-story#acceptance-criteria-using-cucumber-language)
